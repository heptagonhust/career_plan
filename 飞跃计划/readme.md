...
如果是发助教的工资，则要求比较高，或许会有先录取再考语言考试，注意查看相关学校要求。(Purdue，ECE系直接拿TA要TOEFL 27分或以上，其余的要参加一个Purdue的口语考试（OEPP）后才有资格申请TA。https://www.1point3acres.com/bbs/thread-118473-1-1.html)
## 对成绩的要求
